...
%% Sample time
Tf = 20;               % Simulation stop time. [s]
Ts = 0.01;           % Time step for Reinforcement Learning agent. [s]
...
mdl='QubeServo2_Inverted_Pendulum_System';
open_system(mdl)
%SandBAgent1 = mdl + "/Subsystem1/RL Agent2";
%SandBAgent2 = mdl + "/Subsystem/RL Agent3";

%simEnv_SB = rlSimulinkEnv(mdl,[SandBAgent1,SandBAgent2],obsInfo,actInfo);
%simEnv_3.ResetFcn = @localResettFcnSandB;