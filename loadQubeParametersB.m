...
%% Initial condition
theta0 = (60*(rand()-.5))*pi/180;
phi0 = (20*(rand()-.5)+180)*pi/180;
dtheta0 = 0;
dphi0 = 0;
...
mdl='QubeServo2IPbalancing';
open_system(mdl)
RLAgent = mdl + "/RL Agent";
simEnv_2 = rlSimulinkEnv(mdl,RLAgent,obsInfo,actInfo);
simEnv_2.ResetFcn = @localResettFcnB;